...
[Collection/export verification](docs/18-COLLECTION-AND-EXPORT-VERIFICATION.md) tracks the next cohort: durable acquisition/evaluation outcomes, consistent bounded JSON/CSV session exports and connected System diagnostics. PR #89 is the accepted baseline. Match the latest record's tested commit to the branch before claiming acceptance.
