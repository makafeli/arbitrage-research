...
Eight offline regression tests cover repeated import, uncertain create outcomes, duplicate markers, preservation of operator notes/status, link rewriting, dependency cycles and shell-safe argument passing. These tests do not certify live API permissions or native Project/Wiki publication; only completed remote phases establish those results.
